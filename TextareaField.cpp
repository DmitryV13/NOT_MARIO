...
#include "TextareaField.h"
	...
	TextareaField::TextareaField(float x, float y, float width_, float height_, const string& input_label_,
		...
		:InputField(x, y, width_, height_, input_label_, font_, text_size_, text_color_, has_limit_, limit_, true) {
	...
	TextareaField::TextareaField(float x, float y, float width_, float height_, const string& input_label_, 
		...
		:InputField(x, y, width_, height_, input_label_, font_, text_size_, Color::Black, has_limit_, limit_, true) {
		fi_type = FORM_ITEM_TYPE::TEXTAREA_FIELD;
